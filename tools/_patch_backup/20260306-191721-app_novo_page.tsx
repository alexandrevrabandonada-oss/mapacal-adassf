            ...
            {nearbyItems.length > 0 ? (
              <div className="space-y-2 border-2 border-[var(--ink)] bg-white p-3">
                <p className="text-xs font-bold uppercase tracking-[0.12em]">
                  Ja existe ponto perto daqui. Antes de criar outro, confira se um deles ja representa o problema.
                </p>
                <ul className="space-y-2 text-sm">
                  {nearbyItems.map((item) => (
                    <li key={item.id} className="border border-zinc-300 p-2">
                      <p>
                        <span className="font-semibold">Condicao:</span> {item.condition}
                      </p>
                      <p>
